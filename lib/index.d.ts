 ...
 */
declare type ConfirmedBlockSignatures = {
    /** Blockhash of this block */
    blockhash: Blockhash;
    /** Blockhash of this block's parent */
    previousBlockhash: Blockhash;
 ...
 */
declare type AccountChangeCallback = (accountInfo: AccountInfo<Buffer>, context: Context) => void;
/**
 * Callback function for program account change notifications
 */
declare type ProgramAccountChangeCallback = (keyedAccountInfo: KeyedAccountInfo, context: Context) => void;
/**
 ...
 */
declare type SignatureResultCallback = (signatureResult: SignatureResult, context: Context) => void;
/**
 ...
 */
declare type SignatureSubscriptionCallback = (notification: SignatureStatusNotification | SignatureReceivedNotification, context: Context) => void;
/**
 ...
 * </pre>
 */
declare type TransactionConfirmationStatus = 'processed' | 'confirmed' | 'finalized';
/**
 * Signature status
 */
 ...
 */
declare type FetchMiddleware = (url: string, options: any, fetch: Function) => void;
/**
...
declare class Connection {
     ...
     */
    getConfirmedBlockSignatures(slot: number, commitment?: Finality): Promise<ConfirmedBlockSignatures>;
    /**
     ...
     */
    simulateTransaction(transaction: Transaction, signers?: Array<Signer>): Promise<RpcResponseAndContext<SimulatedTransactionResponse>>;
    /**
 ...
 */
declare type StakeInstructionType = 'AuthorizeWithSeed' | 'Authorize' | 'Deactivate' | 'Delegate' | 'Initialize' | 'Split' | 'Withdraw';
/**
 ...
 */
declare type SystemInstructionType = 'AdvanceNonceAccount' | 'Allocate' | 'AllocateWithSeed' | 'Assign' | 'AssignWithSeed' | 'AuthorizeNonceAccount' | 'Create' | 'CreateWithSeed' | 'InitializeNonceAccount' | 'Transfer' | 'TransferWithSeed' | 'WithdrawNonceAccount';
/**
 ...
 */
declare function sendAndConfirmTransaction(connection: Connection, transaction: Transaction, signers: Array<Signer>, options?: ConfirmOptions): Promise<TransactionSignature>;
...
export { Account, AccountBalancePair, AccountChangeCallback, AccountInfo, AccountMeta, AdvanceNonceParams, AllocateParams, AllocateWithSeedParams, AssignParams, AssignWithSeedParams, AuthorizeNonceParams, AuthorizeStakeParams, AuthorizeWithSeedStakeParams, Authorized, BPF_LOADER_DEPRECATED_PROGRAM_ID, BPF_LOADER_PROGRAM_ID, Blockhash, BpfLoader, Cluster, Commitment, CompiledInnerInstruction, CompiledInstruction, ConfirmOptions, ConfirmedBlock, ConfirmedBlockSignatures, ConfirmedSignatureInfo, ConfirmedSignaturesForAddress2Options, ConfirmedTransaction, ConfirmedTransactionMeta, Connection, ConnectionConfig, ContactInfo, Context, CreateAccountParams, CreateAccountWithSeedParams, CreateNonceAccountParams, CreateNonceAccountWithSeedParams, CreateSecp256k1InstructionWithEthAddressParams, CreateSecp256k1InstructionWithPrivateKeyParams, CreateSecp256k1InstructionWithPublicKeyParams, CreateStakeAccountParams, CreateStakeAccountWithSeedParams, DataSizeFilter, DataSlice, DeactivateStakeParams, DelegateStakeParams, EpochCredits, EpochInfo, EpochSchedule, FeeCalculator, FetchMiddleware, Finality, GetLargestAccountsConfig, GetParsedProgramAccountsConfig, GetProgramAccountsConfig, GetProgramAccountsFilter, HttpHeaders, InflationGovernor, InflationReward, Info, InitializeNonceParams, InitializeStakeParams, KeyedAccountInfo, Keypair, LAMPORTS_PER_SOL, LargestAccountsFilter, LeaderSchedule, Loader, Lockout, Lockup, Logs, LogsCallback, LogsFilter, MAX_SEED_LENGTH, MemcmpFilter, Message, MessageArgs, MessageHeader, NONCE_ACCOUNT_LENGTH, NonceAccount, PACKET_DATA_SIZE, ParsedAccountData, ParsedConfirmedTransaction, ParsedConfirmedTransactionMeta, ParsedInnerInstruction, ParsedInstruction, ParsedMessage, ParsedMessageAccount, ParsedTransaction, PartiallyDecodedInstruction, PerfSample, ProgramAccountChangeCallback, PublicKey, RootChangeCallback, RpcResponseAndContext, STAKE_CONFIG_ID, SYSVAR_CLOCK_PUBKEY, SYSVAR_INSTRUCTIONS_PUBKEY, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, SYSVAR_RENT_PUBKEY, SYSVAR_REWARDS_PUBKEY, SYSVAR_STAKE_HISTORY_PUBKEY, Secp256k1Program, SendOptions, SerializeConfig, SignaturePubkeyPair, SignatureReceivedNotification, SignatureResult, SignatureResultCallback, SignatureStatus, SignatureStatusConfig, SignatureStatusNotification, SignatureSubscriptionCallback, SignatureSubscriptionOptions, Signer, SimulatedTransactionResponse, SlotChangeCallback, SlotInfo, SlotUpdate, SlotUpdateCallback, SplitStakeParams, StakeActivationData, StakeAuthorizationLayout, StakeAuthorizationType, StakeInstruction, StakeInstructionType, StakeProgram, Supply, SystemInstruction, SystemInstructionType, SystemProgram, TokenAccountBalancePair, TokenAccountsFilter, TokenAmount, TokenBalance, Transaction, TransactionConfirmationStatus, TransactionError, TransactionInstruction, TransactionInstructionCtorFields, TransactionSignature, TransferParams, TransferWithSeedParams, VALIDATOR_INFO_KEY, VOTE_PROGRAM_ID, ValidatorInfo, Version, VoteAccount, VoteAccountInfo, VoteAccountStatus, WithdrawNonceParams, WithdrawStakeParams, clusterApiUrl, sendAndConfirmRawTransaction, sendAndConfirmTransaction };
